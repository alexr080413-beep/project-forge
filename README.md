...
| [FORGE_STUDIO_EXERCISE_DESIGNER.md](FORGE_STUDIO_EXERCISE_DESIGNER.md) | Project Atlas planning workspace, Exercise Designer purpose, design-validate-publish-execute lifecycle, planned-to-live object mapping, and human approval principle. |
